...
for currfolder in folder:
    ...
    labels_folder = os.path.join(cwd,f"construction_video_OD/{currfolder}/labels/")
    annotations_folder = os.path.join(cwd,f"construction_video_OD/{currfolder}/annotations/")
